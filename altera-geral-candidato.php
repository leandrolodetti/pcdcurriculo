...
<form style="padding-top: 15px; min-width: 300px; max-width: 300px;">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="idAlteraNomeCandidato" name="nome">
  </div>

  <div class="form-group">
      <label for="idAlteraSobrenomeCandidato">Sobrenome</label>
      <input type="text" class="form-control" name="sobrenome" id="idAlteraSobrenomeCandidato">
  </div>

  <div class="form-group">
    <label for="idAlteraEmailCandidato">E-mail</label>
    <input type="txt" class="form-control" id="idAlteraEmailCandidato">
  </div>
