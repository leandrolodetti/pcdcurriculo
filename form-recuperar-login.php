...
elseif (isset($_GET["token"]) && $_GET["token"] != null && isset($_GET["empresa"]) && $_GET["empresa"] != null) {
 	
	$idEmpresa = $_GET["empresa"];
	$token = $_GET["token"];

	$encontrou = buscaUmRegistro($conexao, $idEmpresa, "RecuperaLogin", "Empresa_idEmpresa");
