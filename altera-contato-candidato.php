  ...
  <div class="row">
    <div class="col-sm">
 			...
 			<div class="form-group">
 				...
 				<input type="text" value autocomplete="off" class="form-control" id="idAlteraContatoCandidato" name="contato" style="min-width: 200px; max-width: 200px;">
 			</div>

 			<div class="form-group">
 				<label for="cep">CEP</label>
 				<input type="text" class="form-control" onblur="pesquisacep(this.value);" id="cep" style="min-width: 200px; max-width: 200px;">
 			</div>

 			<div class="form-group">
 				<label for="cidade">Cidade</label>
 				<input type="text" class="form-control" readonly="readonly" id="cidade" style="min-width: 300px; max-width: 300px;">
 			</div>

 			<div class="form-group">
 				<label for="uf">Estado</label>
 				<input type="text" class="form-control" readonly="readonly" id="uf" style="min-width: 100px; max-width: 100px;">
 			</div>
    ...
    <div class="col-sm">
    	...
    	<div class="form-group">
    	  ...
    	  <input type="text" class="form-control" id="idAlteraContatoCandidatoNumero" style="min-width: 100px; max-width: 100px;">
    	</div>
    	<div class="form-group">
    	    <label for="bairro">Bairro</label>
    	    <input type="text" class="form-control" id="bairro" style="min-width: 300px; max-width: 300px;">
    	</div>
    	<div class="form-group">
    	    <label for="idAlteraContatoCandidatoComplemento">Complemento</label>
    	    <input type="text" class="form-control" id="idAlteraContatoCandidatoComplemento" style="min-width: 300px; max-width: 300px;">
    	</div>
